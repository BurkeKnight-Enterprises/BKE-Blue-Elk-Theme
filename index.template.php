...
<head>
	...
	// Show all the relative links, such as help, search, contents, and the like.
		...
		if (!empty($settings['custom_favicon']))
	{
			echo '
	<link rel="shortcut icon" sizes="196x196" href="' . $settings['custom_favicon'] . '" />';
	}
	elseif (empty($context['custom_favicon']))
	{
	echo '
		...
		<div class="wrapper">
			...
			echo '</div>';
				if(!empty($settings['custom_copyright']))
					echo '
						' . $settings['custom_copyright'] . '</br />'; echo ' ',
					theme_copyright(), '
